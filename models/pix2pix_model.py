...
class Pix2PixModel(BaseModel):
    ...
    def backward_D(self):
        ...
        # print('fake b leaf {} requires_grad {}'.format(self.fake_B.is_leaf, self.fake_B.grad))
        # print('real b leaf000 {} requires_grad000 {}'.format(self.real_B.is_leaf, self.real_B.grad))
    def backward_G(self):
